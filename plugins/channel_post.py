...
command_list = ['start', 'users', 'broadcast', 'batch', 'genlink', 'help', 'cmd', 'info', 'add_fsub', 'fsub_chnl', 'restart', 'del_fsub', 'add_admins', 'del_admins', 'admin_list', 'cancel', 'auto_del', 'forcesub', 'files', 'add_banuser', 'del_banuser', 'banuser_list', 'status', 'search', 'req_fsub', 'setexpire',  'setjoinmode', 'approvegroup',  'disapprovegroup', 'index', 'setsearchmode', 'flink']
