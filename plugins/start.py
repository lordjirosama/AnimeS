    ...
    if len(text)>7:
        ...
        reply_markup=InlineKeyboardMarkup([
                    ...
                    [InlineKeyboardButton("• ᴀʙᴏᴜᴛ", callback_data='about'),
                     InlineKeyboardButton("ʜᴇʟᴘ •", url='https://t.me/weebxcrew')],
                    [InlineKeyboardButton("• ᴏᴜʀ ᴄᴏᴍᴍᴜɴɪᴛʏ •", url='https://t.me/crewverse')],
                ])
        ...
        for total, chat_id in enumerate(await kingdb.get_all_channels(), start=1):
            ...
            if not await is_userJoin(client, user_id, chat_id):
                try:
                    ...
                    return await temp.edit(f"<b><i>! Eʀʀᴏʀ, Cᴏɴᴛᴀᴄᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ ᴛᴏ sᴏʟᴠᴇ ᴛʜᴇ ɪssᴜᴇs @i_killed_my_clan</i></b>\n<blockquote expandable><b>Rᴇᴀsᴏɴ:</b> {e}</blockquote>")
